    ...
    return (
        <div className="card p-3 m-2 shadow-sm" style={{ width: '300px', borderRadius: '12px', background: 'white', border: '1px solid #ddd' }}>
            ...
            <div className="hotel-card">
                ...
                <div className="hotel-name">{guide.full_name}</div>
                
                <div className="hotel-description">{guide.description}</div>
                <div className="hotel-info">📍 {guide.area_cover}</div>
                <div className="hotel-info">📞 {guide.contact_number}</div>
                
                <button className="btn btn-primary mt-2">
                                <Link to={"/tourist/viewguide/" + guide.guide_id} >
                                View Details
                                </Link>
                            </button>
            </div>
