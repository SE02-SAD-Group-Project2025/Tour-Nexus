    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-sky-50 to-emerald-50 overflow-x-hidden">
          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center space-x-3 group">
              <div className="relative">
                <div className="w-12 h-12 bg-gradient-to-br from-teal-400 via-emerald-500 to-sky-500 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
              ...
              <div>
                <span className="text-2xl font-black bg-gradient-to-r from-teal-600 via-emerald-600 to-sky-600 bg-clip-text text-transparent animate-gradient">
                  TourNexus
                </span>
                <div className="text-xs text-gray-500 font-medium animate-fade-in">
                  Discover Paradise
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <button className="bg-gradient-to-r from-teal-500 to-emerald-500 text-white px-6 py-2.5 rounded-full font-semibold hover:shadow-lg hover:shadow-teal-500/25 transform hover:scale-105 transition-all duration-300 animate-pulse-slow">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-6xl mx-auto px-4">
          ...
          <p
            className="text-xl md:text-2xl mb-12 text-gray-200 max-w-4xl mx-auto leading-relaxed animate-fade-in-up opacity-0"
      ...
      <section className="py-32 relative overflow-hidden bg-gradient-to-br from-gray-900 via-slate-900 to-gray-800">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-20 w-96 h-96 bg-teal-500/30 rounded-full blur-3xl animate-pulse-slow"></div>
          <div
            className="absolute bottom-20 right-20 w-72 h-72 bg-emerald-500/30 rounded-full blur-3xl animate-pulse-slow"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20 animate-fade-in-up">
            <div className="inline-flex items-center px-6 py-3 bg-teal-500/20 backdrop-blur-md rounded-full mb-6 border border-teal-400/30 hover:bg-teal-500/30 transition-all duration-300 cursor-pointer">
              <Camera className="w-5 h-5 mr-2 text-teal-300 animate-pulse" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="group relative overflow-hidden rounded-3xl shadow-2xl hover:shadow-teal-500/25 transform hover:scale-105 transition-all duration-700 h-96 cursor-pointer animate-fade-in-up opacity-0"
                style={{
              ...
              >
                ...
                <div className="absolute top-6 left-6 z-30">
                  <div className="px-4 py-2 bg-black/40 backdrop-blur-md rounded-full border border-white/20 group-hover:bg-white/20 transition-all duration-300">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white z-30">
                  <div className="transform translate-y-8 group-hover:translate-y-0 transition-transform duration-500">
                    ...
                    <p className="text-gray-300 mb-4 leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                      {destination.description}
                    </p>
                    <button className="group/btn flex items-center px-6 py-3 bg-white/20 backdrop-blur-md rounded-full hover:bg-white/30 transition-all duration-300 border border-white/30 opacity-0 group-hover:opacity-100">
      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-in-up">
            <div className="inline-flex items-center px-6 py-3 bg-emerald-100 rounded-full mb-6 hover:scale-105 transition-transform duration-300 cursor-pointer">
              <TrendingUp className="w-5 h-5 mr-2 text-emerald-600 animate-bounce-slow" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={index}
                className="text-center group cursor-pointer animate-fade-in-up opacity-0"
                style={{
                  animationDelay: `${index * 100}ms`,
                  animationFillMode: "forwards",
                }}
              >
                <div className="relative mb-6">
                  <div
                    className={`w-24 h-24 mx-auto bg-gradient-to-br ${stat.color} rounded-3xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-xl group-hover:shadow-2xl`}
                  >
                    <stat.icon className="w-12 h-12 text-white group-hover:scale-110 transition-transform duration-300" />
                  </div>
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${stat.color} rounded-3xl opacity-0 group-hover:opacity-30 blur-xl transition-all duration-500 scale-150`}
                  ></div>
                </div>
                <div className="text-4xl md:text-5xl font-black text-gray-800 mb-2 group-hover:text-teal-600 transition-colors duration-300">
                  <span className="inline-block group-hover:scale-110 transition-transform duration-300">
                    {stat.number}
                  </span>
                </div>
                <div className="text-lg font-bold text-gray-700 mb-2 group-hover:text-gray-900 transition-colors duration-300">
                  {stat.label}
                </div>
      ...
      <section id="services" className="py-32 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-10 left-10 w-72 h-72 bg-teal-200/30 rounded-full blur-3xl animate-morph"></div>
          <div className="absolute bottom-10 right-10 w-96 h-96 bg-emerald-200/30 rounded-full blur-3xl animate-morph-delayed"></div>
        </div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20 animate-fade-in-up">
            <div className="inline-flex items-center px-6 py-3 bg-teal-100 rounded-full mb-6 hover:scale-105 transition-transform duration-300 cursor-pointer">
              <Sparkles className="w-5 h-5 mr-2 text-teal-600 animate-sparkle" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={index}
                className={`group relative bg-gradient-to-br ${service.bgColor} rounded-3xl p-8 shadow-xl hover:shadow-2xl ${service.shadowColor} transform hover:-translate-y-4 transition-all duration-700 overflow-hidden border border-white/50 animate-fade-in-up opacity-0 hover:rotate-1`}
                style={{
              ...
              >
                ...
                <div
                  className={`w-20 h-20 bg-gradient-to-br ${service.color} rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 shadow-lg relative z-10`}
                >
                  <service.icon className="w-10 h-10 text-white group-hover:scale-110 transition-transform duration-300" />
                </div>

                <h3 className="text-2xl font-bold text-gray-900 mb-4 group-hover:text-teal-700 transition-colors duration-300 relative z-10">
                  {service.title}
                </h3>
                ...
                <ul className="space-y-2 mb-6 relative z-10">
                  {service.features.map((feature, idx) => (
                    ...
                    >
                      <div
                        className={`w-2 h-2 bg-gradient-to-r ${service.color} rounded-full mr-3 group-hover:scale-150 transition-transform duration-300`}
                      ></div>
                      {feature}
                    </li>
                  ))}
                ...
                <button
                  className={`w-full bg-gradient-to-r ${service.color} text-white py-3 rounded-xl font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300 relative z-10 overflow-hidden group`}
                >
      ...
      >
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 opacity-20">
            <div className="absolute top-20 left-20 w-72 h-72 bg-teal-500/20 rounded-full blur-3xl animate-pulse-slow"></div>
            <div
              className="absolute bottom-20 right-20 w-96 h-96 bg-emerald-500/20 rounded-full blur-3xl animate-pulse-slow"
              style={{ animationDelay: "2s" }}
            ></div>
          </div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20 animate-fade-in-up">
            <div className="inline-flex items-center px-6 py-3 bg-teal-500/20 backdrop-blur-md rounded-full mb-6 border border-teal-400/30 hover:bg-teal-500/30 transition-all duration-300 cursor-pointer">
              <Mountain className="w-5 h-5 mr-2 text-teal-300 animate-bounce-slow" />
              <span className="text-teal-300 font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {[
              ...
              <div
                key={index}
                className="group relative overflow-hidden rounded-3xl shadow-2xl hover:shadow-teal-500/25 transform hover:scale-105 transition-all duration-700 h-[450px] cursor-pointer animate-fade-in-up opacity-0"
                style={{
                  animationDelay: `${index * 100}ms`,
                  animationFillMode: "forwards",
                }}
              >
                ...
                <div className="absolute top-6 left-6 z-30 animate-slide-down">
                  <div className="flex items-center px-4 py-2 bg-black/40 backdrop-blur-md rounded-full border border-white/20 group-hover:bg-white/20 transition-all duration-300">
                    <destination.icon className="w-4 h-4 mr-2 text-teal-300 group-hover:rotate-12 transition-transform duration-300" />
                    <span className="text-white text-sm font-medium">
                      {destination.category}
                    </span>
                  </div>
                ...
                <div
                  className="absolute top-6 right-6 z-30 animate-slide-down"
                  style={{ animationDelay: "200ms" }}
                >
                  <div className="flex items-center px-3 py-1.5 bg-yellow-500/90 backdrop-blur-md rounded-full">
                    <Star className="w-4 h-4 mr-1 text-white fill-current" />
                ...
                {/* Price Badge */}
                <div
                  className="absolute top-20 right-6 z-30 animate-slide-down"
                  style={{ animationDelay: "400ms" }}
                >
                  <div className="px-3 py-1.5 bg-emerald-500/90 backdrop-blur-md rounded-full">
                    <span className="text-white text-sm font-bold">
                      {destination.price}
                    </span>
                  </div>
          ...
          <div className="text-center animate-fade-in-up">
            <button className="group inline-flex items-center px-12 py-6 bg-gradient-to-r from-teal-500 to-emerald-500 text-white rounded-full font-bold text-xl hover:shadow-lg hover:shadow-teal-500/25 transform hover:scale-105 transition-all duration-300">
              <Compass className="w-6 h-6 mr-3 group-hover:rotate-45 transition-transform duration-300" />
      ...
      <section className="py-32 relative overflow-hidden bg-gradient-to-br from-slate-50 via-sky-50 to-emerald-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20 animate-fade-in-up">
            <div className="inline-flex items-center px-6 py-3 bg-emerald-100 rounded-full mb-6 hover:scale-105 transition-transform duration-300 cursor-pointer">
              <Heart className="w-5 h-5 mr-2 text-emerald-600 animate-pulse" />
              <span className="text-emerald-700 font-semibold">
                Traveler Stories
              </span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {[
              ...
              <div
                key={index}
                className="group relative bg-white rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 animate-fade-in-up opacity-0"
                style={{
                  animationDelay: `${index * 150}ms`,
                  animationFillMode: "forwards",
                }}
              >
                ...
                <div className="h-48 overflow-hidden relative">
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    <div className="text-sm font-medium bg-black/40 backdrop-blur-md px-3 py-1 rounded-full">
                ...
                <div className="relative -mt-12 px-6 pb-6">
                  ...
                  <p className="text-sm text-teal-600 font-medium flex items-center mb-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              >
                <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-teal-400 to-emerald-500 rounded-3xl flex items-center justify-center shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
                  <item.icon className="w-10 h-10 text-white group-hover:rotate-12 transition-transform duration-300" />
                </div>
                <div className="text-4xl font-black text-gray-900 mb-2 group-hover:text-teal-600 transition-colors duration-300">
                  <span className="inline-block group-hover:scale-110 transition-transform duration-300">
                    {item.metric}
                    {item.suffix}
                  </span>
                </div>
                <div className="text-lg font-bold text-gray-700 mb-1 group-hover:text-gray-900 transition-colors duration-300">
                  {item.label}
                </div>
                <div className="text-sm text-gray-500 group-hover:text-gray-700 transition-colors duration-300">
                  {item.description}
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute bottom-20 right-20 w-64 h-64 bg-white/10 rounded-full blur-2xl animate-pulse-slow"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-white/5 rounded-full blur-3xl animate-pulse-slow"
            style={{ animationDelay: "2s" }}
          ></div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="mb-8 animate-fade-in-down">
            <div className="inline-flex items-center px-8 py-4 bg-white/20 backdrop-blur-md rounded-full border border-white/30 mb-8 hover:bg-white/30 transition-all duration-300 cursor-pointer">
              <Sparkles className="w-6 h-6 mr-3 text-white animate-sparkle" />
              <span className="text-white font-semibold text-lg">
                Limited Time Offer - 20% OFF First Booking
              </span>
              <Sparkles
                className="w-6 h-6 ml-3 text-white animate-sparkle"
                style={{ animationDelay: "0.5s" }}
              />
            </div>
          </div>

          <h2 className="text-5xl md:text-7xl font-black text-white mb-8 leading-tight animate-fade-in-up">
            Your Adventure
          ...
          <p
            className="text-xl md:text-2xl text-white/90 mb-12 max-w-4xl mx-auto leading-relaxed animate-fade-in-up"
            style={{ animationDelay: "200ms" }}
          >
          ...
          >
            ...
            <button className="group bg-white/20 backdrop-blur-md text-white px-12 py-6 rounded-full text-xl font-bold hover:bg-white/30 transition-all duration-500 border-2 border-white/30 flex items-center justify-center overflow-hidden relative">
          ...
          <div
            className="flex flex-wrap justify-center items-center gap-8 opacity-80 animate-fade-in-up"
          ...
          >
            {[
              ...
              <div
                key={index}
                className="flex items-center text-white hover:scale-110 transition-transform duration-300 cursor-pointer"
              >
                <item.icon
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
            ...
            <div className="lg:col-span-2 animate-fade-in-up">
              <div className="flex items-center space-x-3 mb-8">
                <div className="w-14 h-14 bg-gradient-to-br from-teal-400 via-emerald-500 to-sky-500 rounded-2xl flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-300">
              ...
              <div className="flex space-x-4">
                {[
                  ...
                  <a
                    key={index}
                    href={social.href}
                    className={`w-12 h-12 bg-gray-800 ${social.color} rounded-xl flex items-center justify-center transition-all duration-300 group hover:scale-110 hover:rotate-6`}
                  >
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-center text-gray-400 hover:text-teal-400 transition-colors duration-300 cursor-pointer group">
                  <Phone className="w-5 h-5 mr-3 text-teal-400 group-hover:scale-110 transition-transform duration-300" />
                  <span>+94 76 100 7188</span>
                </div>
                <div className="flex items-center text-gray-400 hover:text-teal-400 transition-colors duration-300 cursor-pointer group">
                  <Mail className="w-5 h-5 mr-3 text-teal-400 group-hover:scale-110 transition-transform duration-300" />
                  <span>tournexus@gmail.com</span>
                </div>
                <div className="flex items-start text-gray-400 group">
                  <MapPin className="w-5 h-5 mr-3 text-teal-400 mt-1 group-hover:scale-110 transition-transform duration-300" />
                  <span>
                    No.11 Galle Road,
                    <br />
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-8 right-8 z-40 w-14 h-14 bg-gradient-to-r from-teal-500 to-emerald-500 text-white rounded-full shadow-lg hover:shadow-xl transform transition-all duration-500 flex items-center justify-center group ${
          showScrollTop
      ...
      >
        ...
        <ChevronUp className="w-6 h-6 relative z-10 group-hover:translate-y-[-2px] transition-transform duration-300" />
