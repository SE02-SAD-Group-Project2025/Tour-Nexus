...
const AddHotelForm = () => {
  ...
  const removeRoomImage = (imageId) => {
    setRoomTypesData(prev => {
      const updated = [...prev];
      if (!updated[currentRoomIndex] || !updated[currentRoomIndex].images) return prev;
      
      const imageToRemove = updated[currentRoomIndex].images.find(img => img.id === imageId);
      if (imageToRemove) {
      ...
      updated[currentRoomIndex] = {
        ...updated[currentRoomIndex],
        images: updated[currentRoomIndex].images.filter(img => img.id !== imageId)
      };
      return updated;
    });
  };
  ...
  const submitHotel = async () => {
    ...
    try {
      ...
      for (let i = 0; i < roomTypesData.length; i++) {
        ...
        const roomImagePromises = roomType.images.map(img => mediaUpload(img.file));
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 text-center">
        ...
        <p className="text-gray-600 mb-6">
          Tell us how many different types of rooms you offer. For example: Standard Room, Deluxe Room, Suite, etc.
        </p>
        ...
        <div className="flex justify-center mb-6">
          <input
            ...
            max="10"
            value={roomTypeCount || ''}
            onChange={(e) => handleRoomTypeCountChange(parseInt(e.target.value) || 0)}
        ...
        {roomTypeCount > 0 && (
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-sm text-blue-800">
              Great! You will configure <strong>{roomTypeCount}</strong> room type{roomTypeCount > 1 ? 's' : ''} in the next steps.
            </p>
          </div>
        )}
      </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => updateCurrentRoomData('count', parseInt(e.target.value) || 1)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => updateCurrentRoomData('price', parseFloat(e.target.value) || 0)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mb-4">
              <label className="flex items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-sm text-gray-600">Click to upload room images</span>
            ...
            <div className="mt-3 text-xs text-gray-500">
              {currentRoom.images ? currentRoom.images.length : 0} image(s) uploaded for this room type
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
        ...
        <p className="text-gray-600 mb-4">
          Upload images of your hotel's common areas, exterior, lobby, restaurant, pool, etc. These images will help guests understand your hotel's atmosphere and facilities.
        </p>
        ...
        <div className="mb-4">
          <label className="flex items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
            <div className="flex flex-col items-center">
              <Upload className="w-8 h-8 text-gray-400 mb-2" />
              <span className="text-sm text-gray-600">Click to upload hotel images</span>
              <span className="text-xs text-gray-400">PNG, JPG up to 10MB each</span>
            </div>
            <input
              type="file"
        ...
        <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
          <h4 className="text-sm font-medium text-green-800 mb-2">Room Types Summary:</h4>
          ...
          <div className="text-sm text-green-700 mt-2 font-medium">
            Total Rooms: {roomTypesData.reduce((total, room) => total + parseInt(room.count), 0)}
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          {currentStep >= 3 && currentStep < 3 + roomTypeCount && renderRoomTypeStep()}
